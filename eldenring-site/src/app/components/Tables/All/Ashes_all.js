...
export function AshesAllDemo({items}) {
      ...
      <Table className="w-full">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-slate-950 dark:text-slate-50 w-[5vh]">Skill</TableHead>
            <TableHead className="text-slate-950 dark:text-slate-50 w-[5vh]">Affinity</TableHead>
        ...
        <TableBody className="overflow-y-auto">
          {items.map((item) => (
            <TableRow key={item.id}>
                ...
                <TableCell className="text-slate-950 dark:text-slate-50">{item.skill}</TableCell>
                <TableCell className="text-slate-950 dark:text-slate-50">{item.affinity}</TableCell>
