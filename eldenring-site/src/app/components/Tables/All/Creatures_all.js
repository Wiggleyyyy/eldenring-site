...
export function CreaturesAllDemo({items}) {
      ...
      <Table className="w-full">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-slate-950 dark:text-slate-50 w-[15vh]">Location(s)</TableHead>
            <TableHead className="text-slate-950 dark:text-slate-50 w-[10vh]">Drops</TableHead>
        ...
        <TableBody className="overflow-y-auto">
          {items.map((item) => (
            <TableRow key={item.id}>
                ...
                <TableCell className="text-slate-950 dark:text-slate-50">{item.drops}</TableCell>
