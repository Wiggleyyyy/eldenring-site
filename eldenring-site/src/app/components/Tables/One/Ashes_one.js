...
export function AshesOneDemo({ item }) {
    ...
    <div className="w-[100%] min-h-[100dvh] h-[100%]">
      <div className="flex flex-col items-center justify-center ">
        <div className="flex flex-col items-center justify-center my-3 bg-slate-400 dark:bg-slate-800 rounded-lg p-3">
            ...
            <Label className="text-slate-950 dark:text-slate-50 my-3">Affinity: {item.affinity}</Label>
            <Label className="text-slate-950 dark:text-slate-50 my-3">Skill: {item.skill}</Label>
            <hr className="h-[0.2vh] w-[90%] bg-slate-50" />
